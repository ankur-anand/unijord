...
/*
Package readerv1 is a reverse proxy.
...
func request_ReaderService_ConsumePartition_0(ctx context.Context, marshaler runtime.Marshaler, client ReaderServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq ConsumePartitionRequest
		metadata runtime.ServerMetadata
		err      error
	)
	if req.Body != nil {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ReaderService_ConsumePartition_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	msg, err := client.ConsumePartition(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_ReaderService_ConsumePartition_0(ctx context.Context, marshaler runtime.Marshaler, server ReaderServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq ConsumePartitionRequest
		metadata runtime.ServerMetadata
		err      error
	...
	msg, err := server.ConsumePartition(ctx, &protoReq)
	return msg, metadata, err
}
...
func request_ReaderService_TailPartition_0(ctx context.Context, marshaler runtime.Marshaler, client ReaderServiceClient, req *http.Request, pathParams map[string]string) (ReaderService_TailPartitionClient, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ReaderService_TailPartition_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	stream, err := client.TailPartition(ctx, &protoReq)
	if err != nil {
...
// RegisterReaderServiceHandlerServer registers the http handlers for service ReaderService to "mux".
// UnaryRPC     :call ReaderServiceServer directly.
...
func RegisterReaderServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ReaderServiceServer) error {
	...
	mux.Handle(http.MethodGet, pattern_ReaderService_ConsumePartition_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/eventlake.reader.v1.ReaderService/ConsumePartition", runtime.WithHTTPPathPattern("/api/partitions/{partition}/consume"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ReaderService_ConsumePartition_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
...
// RegisterReaderServiceHandlerFromEndpoint is same as RegisterReaderServiceHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterReaderServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterReaderServiceHandler(ctx, mux, conn)
}

// RegisterReaderServiceHandler registers the http handlers for service ReaderService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterReaderServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterReaderServiceHandlerClient(ctx, mux, NewReaderServiceClient(conn))
}

// RegisterReaderServiceHandlerClient registers the http handlers for service ReaderService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "ReaderServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "ReaderServiceClient"
...
func RegisterReaderServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ReaderServiceClient) error {
	...
	mux.Handle(http.MethodGet, pattern_ReaderService_ConsumePartition_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/eventlake.reader.v1.ReaderService/ConsumePartition", runtime.WithHTTPPathPattern("/api/partitions/{partition}/consume"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ReaderService_ConsumePartition_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle(http.MethodGet, pattern_ReaderService_TailPartition_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/eventlake.reader.v1.ReaderService/TailPartition", runtime.WithHTTPPathPattern("/api/partitions/{partition}/tail"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ReaderService_TailPartition_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		}
		forward_ReaderService_TailPartition_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
	})
	return nil
}
