...
func TestValidateLeafPage(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name: "bad header",
			page: leafPage{Version: pageVersion, Type: "index", Partition: 1, SeqLo: 100, SeqHi: 199, Segments: []pmeta.SegmentRef{testSegmentRef(1, 100, 199, 1)}},
		...
		},
		{
			...
			page: leafPage{Version: pageVersion, Type: "leaf", Partition: 2, SeqLo: 100, SeqHi: 199, Segments: []pmeta.SegmentRef{testSegmentRef(1, 100, 199, 1)}},
			want: ErrCorruptCatalog,
		},
		{
			name: "seq lo mismatch",
			page: leafPage{Version: pageVersion, Type: "leaf", Partition: 1, SeqLo: 99, SeqHi: 199, Segments: []pmeta.SegmentRef{testSegmentRef(1, 100, 199, 1)}},
			want: ErrCorruptCatalog,
		},
		{
			name: "gap",
			page: leafPage{Version: pageVersion, Type: "leaf", Partition: 1, SeqLo: 100, SeqHi: 399, Segments: []pmeta.SegmentRef{testSegmentRef(1, 100, 199, 1), testSegmentRef(1, 300, 399, 1)}},
			want: ErrCorruptCatalog,
		},
		{
			name: "timestamp regression",
			page: leafPage{Version: pageVersion, Type: "leaf", Partition: 1, SeqLo: 100, SeqHi: 299, Segments: []pmeta.SegmentRef{testSegmentRef(1, 100, 199, 1), testSegmentRefWithTime(1, 200, 299, 1, 50, 60)}},
			want: pcatalog.ErrTimestampOrder,
		},
		{
			name: "seq hi mismatch",
			page: leafPage{Version: pageVersion, Type: "leaf", Partition: 1, SeqLo: 100, SeqHi: 300, Segments: []pmeta.SegmentRef{testSegmentRef(1, 100, 199, 1), testSegmentRef(1, 200, 299, 1)}},
			want: ErrCorruptCatalog,
		},
	}
