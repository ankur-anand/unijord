...
var (
	ErrInvalidStore = errors.New("blob/sink/multipart: invalid object store")
	ErrAborted      = errors.New("blob/sink/multipart: upload aborted")
	ErrCompleted    = errors.New("blob/sink/multipart: upload completed")
	// ErrPreconditionFailed means the final object already exists or a
	// provider-side conditional write failed.
	ErrPreconditionFailed = errors.New("blob/sink/multipart: precondition failed")
)
