...
import (
	...
	objmultipart "github.com/ankur-anand/unijord/partitionlog/blobsink/multipart"
...
func TestBlobWriterEndToEndWithBlobCatalog(t *testing.T) {
	...
	cat, err := blobcatalog.NewMemory(blobcatalog.Options{})
	if err != nil {
		t.Fatalf("blobcatalog.NewMemory() error = %v", err)
	}
