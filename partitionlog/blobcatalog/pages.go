...
type nextPageSet struct {
	...
	ActiveSegments []pcatalog.SegmentRef
}

func (c *Catalog) buildNextPageSet(ctx context.Context, head headFile, segment pcatalog.SegmentRef, generation uint64) (nextPageSet, error) {
